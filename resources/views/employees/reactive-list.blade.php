<x-app-layout>
    ...
    {{-- Displaying the list of Employees  --}}
        ...
        <div class="py-10">
                                ...
                                <template x-for="employee in filteredEmployee" :key="employee.id">
                                    <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <x-primary-button @click="openEditModal(employee)">
                                                    Modifier
                                                </x-primary-button>
                                                <x-primary-button @click="deleteEmployee(employee)" class="bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded ">
                                                    Supprimer
                                                </x-primary-button>
                                            </td>
                                    </tr>
            ...
            <div x-show="addOpenModal" class="fixed inset-0 overflow-y-auto z-50" style="display: none;" x-cloak>
            ...
            <div x-show="editOpenModal" class="fixed inset-0 overflow-y-auto z-50" style="display: none;" x-cloak>
                <div class="flex flex-wrap items-center justify-center min-h-screen">
                    <div class="relative bg-white p-10 rounded-md">
                        <button @click="openModal = false" class="absolute top-3 right-3 text-gray-700 hover:text-red-600">Fermer</button>
            
                        <form method="POST" action="{{route('employees.update', currentEmployee)}}" class="grid grid-cols-2 gap-4"> 
                            @csrf
                            @method('PUT')
                            <div class="flex flex-col"> <label class="mb-1" for="firstname">Nom:</label>
                                <input type="text" name="firstname" id="firstname" required > 
