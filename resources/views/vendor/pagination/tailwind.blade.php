@if ($paginator->hasPages())
    <nav role="navigation" aria-label="{{ __('Pagination Navigation') }}" class="flex flex-col ">
        ...
        <div class="mt-5 flex flex-col-reverse justify-center align-center gap-2 hidden sm:flex-1 sm:flex sm:items-center sm:justify-between">
            <div class="">
                            ...
                            @foreach ($element as $page => $url)
                                @if ($page == $paginator->currentPage())
                                    <span aria-current="page">
                                        <span class="bg-blue-600 relative inline-flex items-center px-4 py-2 -ml-px text-sm font-medium text-white  border border-gray-300 cursor-default leading-5 ">{{ $page }}</span>
                                    </span>
                                @else
