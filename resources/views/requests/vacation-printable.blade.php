...
<body class="container mx-auto p-4 print-rtl text-xl">
    ...
    <p class="mb-2">إن رئيس قسم الشؤون الإدارية و المالية ل[إسم الشركة]</p>
    ...
    <p>و بناء على النضام الأساسي لموضفي [إسم الشركة] المصادق عليه بتاريخ 12 يوليوز 2010 و حسب ما تم تغييره و تتميه بتاريخ 27 ماي 2014.</p>
    ...
    <p class="mb-10"><span class="font-bold underline">الفصل الثالث:</span> ينوب عن المعني بالأمر طيلة الرخصة السيد : <span class="font-semibold">{{$request->interim}}</span> </p>
